    ...
    <div className="news-container m-0 p-0 py-5">
      <div className="row">
        <div className="text-center">
          <h1 className="text-white text-center news-heading" style={{fontWeight:'bold',fontSize:50}}>
            <span className="heading-gredient" style={{fontWeight:'bold'}}>CCGBTCONE</span> IN THE NEWS
          </h1>
          <p className="text-white text-center mb-5" style={{fontSize:12px}}>
