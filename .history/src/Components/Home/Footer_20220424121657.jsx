...
function Footer() {
  return (
    <footer className="row">
      <div className="mt-5 col-12 col-md-6 d-flex justify-content-center flex-column align-items-center">
        <h2 className="footer-heading">CCGBTCONE NFT CLUB</h2>
        <p className="text-white">
          © 2022 CCGBTCONE NFT CLUB. All rights reserved
        </p>
      </div>
      <div className="col-12 col-md-3 text-white d-flex justify-content-center flex-column align-items-center align-items-md-start">
        <h3>Useful Links</h3>
        <p>Home</p>
        <p>About</p>
        <p>Faq</p>
